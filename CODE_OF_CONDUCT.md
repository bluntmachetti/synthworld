...
In this project, publishing real personal data — anyone's — is both a safety
violation (see [SECURITY.md](SECURITY.md)) and a conduct violation.
...
reported to the maintainers through GitHub's private vulnerability-reporting
form in this repository's **Security** tab, which doubles as the project's
private contact channel. All complaints will be reviewed and investigated
promptly and fairly.
