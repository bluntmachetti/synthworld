.PHONY: ci install lint metrics package test typecheck

UV := uv
SEED := 20260719
PERSONAS := 10
GENERATED_PERSONAS := 100
WHEEL := dist/idcognito_synthworld-0.6.0-py3-none-any.whl
...
ci: lint typecheck package test metrics
