...
| Asteria `wrong_action_evidence_free` | active action rows with no known ID owned by another action / action rows submitting at least one ID | higher is better | Fabricated IDs are handled independently. |
