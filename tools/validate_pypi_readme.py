"""Validate the configured PyPI long-description source and Warehouse rendering."""
...
def resolve_readme_source(readme: Any) -> Path:
    """Resolve the supported PEP 621 README forms to the canonical README path."""
...
def main() -> None:
    # Imported lazily so unit tests can exercise configuration resolution without
    # adding readme-renderer to the repository's development dependency set.
